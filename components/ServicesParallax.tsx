...
const IMAGE_SRC = "/images/parallax-hero.png";
...
export function ServicesParallax({ children }: ServicesParallaxProps) {
  ...
  return (
    <>
      {/* Fixed parallax background - always visible, continues throughout page */}
