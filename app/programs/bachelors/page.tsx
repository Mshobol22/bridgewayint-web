...
const HIGHLIGHTS = [
  {
    emoji: "🎓",
    title: "4-Year Degrees",
    description:
      "Bachelor of Arts (BA) and Bachelor of Science (BS) — 120+ credit hours",
  },
  {
    emoji: "💼",
    title: "Internship Support",
    description:
      "CPT authorization for internships during study; OPT work authorization after graduation",
  },
  {
    emoji: "📚",
    title: "Diverse Majors",
    description:
      "Business, engineering, computer science, health sciences, liberal arts, and more",
  },
  {
    emoji: "📍",
    title: "Nationwide Placements",
    description:
      "State and private universities across the US with strong international student support",
  },
] as const;

const ELIGIBILITY = [
  "High school diploma or equivalent",
  "English proficiency (TOEFL iBT 80+ or IELTS 6.5+ — varies by school)",
  "Valid passport",
  "Financial proof (typically $30,000–$65,000/year for tuition + living)",
...
const TIMELINE = [
  {
    ...
    title: "Initial consultation & university selection",
  },
  {
    step: 2,
        ...
        <div className="mx-auto max-w-4xl px-6 pb-24">
          ...
          >
            ...
            <p className="mt-4 leading-relaxed text-white/60">
              BridgeWay supports international F-1 students pursuing 4-year
              bachelor&apos;s degrees at accredited US universities. State
              universities typically cost $20,000–$50,000/year in tuition; private
              institutions $40,000–$60,000. Programs typically require 120+
              credit hours and can include internship support (CPT) and
              post-graduation work authorization (OPT).
            </p>
          </motion.section>
          ...
          >
            <div className="rounded-2xl border border-slate-700/50 bg-slate-900/50 p-8 text-center backdrop-blur-xl">
              <h2 className="text-2xl font-bold text-white">
                Ready to start your bachelor&apos;s journey in the US?
              </h2>
              <Link
                href="/consultation"
